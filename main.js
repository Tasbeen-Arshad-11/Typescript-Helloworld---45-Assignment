...
const current_users = ["john", "Naveed", "Hashir", "Irfan", "Hassan"];
const new_users = ["Eman", "wania", "Farheen", "Muniba", "Sana"];
// Convert all current usernames to lowercase for case-insensitive comparison
const Checking_current_users_lower = current_users.map(username => username.toLowerCase());
